      ...
      <Card className="w-full max-w-sm border-zinc-800 bg-zinc-900/80 shadow-2xl">
        <CardHeader className="text-center space-y-1">
          ...
          <CardTitle className="text-xl font-bold text-zinc-100 flex items-center justify-center gap-1.5">
            Sign in to Aldan <Sparkles className="h-4 w-4 text-emerald-400" />
          </CardTitle>
          <CardDescription className="text-xs text-zinc-400">
            Access your stateful AI harness and persistent memory
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-center border-t border-zinc-800/80 pt-4">
          <p className="text-xs text-zinc-400">
            ...
            <Link href="/sign-up" className="text-emerald-400 hover:underline font-medium">
              Create one
            </Link>
          </p>
        </CardFooter>
